...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		sb.append("<ul id='paging_point'>");
		// 처음페이지
		if(current_page > 1) {
			sb.append("<li class='paging-side'><a href='"+list_url+"page=1' aria-label='First'><span class='btn-paging first'>처음</span></a></li>");
		} else {
//			sb.append("<li class='disabled'><a href='#' aria-label='First'><span aria-hidden='true' class='glyphicon glyphicon-step-backward'></span></a></li>");
		...
		if(total_page > numPerBlock && currentPageSetup > 0) {
			sb.append("<li class='paging-side'><a href='"+list_url+"page="+n+"' aria-label='Previous'><span aria-hidden='true' class='btn-paging prev'>이전 10개</span></a></li>");
		} else {
//			sb.append("<li class='disabled'><a href='#' aria-label='Previous'><span aria-hidden='true' class='glyphicon glyphicon-triangle-left'></span></a></li>");
		...
		while(page<=total_page && page <=(currentPageSetup+numPerBlock)) {
			if(page==current_page) {
				sb.append("<li class='on'><a href='#'>"+page+" <span class='sr-only'></span></a></li>");
			} else {
		...
		if(total_page-currentPageSetup>numPerBlock) {
			sb.append("<li class='paging-side'><a href='"+list_url+"page="+n+"' aria-label='Next'><span aria-hidden='true' class='btn-paging next'>다음 10개</span></a></li>");
		} else {
//			sb.append("<li class='disabled'><a href='#' aria-label='Next'><span aria-hidden='true' class='glyphicon glyphicon-triangle-right'></span></a></li>");
		...
		if(current_page<total_page) {
			sb.append("<li class='paging-side'><a href='"+list_url+"page="+total_page+"' aria-label='Last'><span aria-hidden='true' class='btn-paging end'>끝</span></a></li>");
		} else {
//			sb.append("<li class='disabled'><a href='#' aria-label='Last'><span aria-hidden='true' class='glyphicon glyphicon-step-forward'></span></a></li>");
    ...
    public String pagingMethod(int current_page, int total_page, String methodName) {
		...
		while(page<=total_page && page <=(currentPageSetup+numPerBlock)) {
			if(page==current_page) {
				sb.append("<li class='on'><a href='#'>"+page+" <span class='sr-only'>(current)</span></a></li>");
			} else {
